...
export default function ResourceFormModal({ onClose, onSave, categories, editingId, initialResource }) {
  ...
  const handleSave = () => {
    ...
    const listItem = {
      ...
      img: updatedUuidData.images[0] || 'https://picsum.photos/220/140',
      updatetime: new Date(currentTime * 1000).toISOString(),
      link: updatedUuidData.link,
      imageUrl: updatedUuidData.images[0] || 'https://picsum.photos/220/140',
      ...
      cover: updatedUuidData.images[0] || 'https://picsum.photos/220/140',
